select distinct u.id, u.idnumber, u.username, u.firstname, u.lastname, u.email, u.institution, c.shortname, r.name as "Resource viewed",  f.filename as "File downloaded" 
from 
